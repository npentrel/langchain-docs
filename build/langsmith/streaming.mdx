...
---
[LangGraph SDK](/langsmith/smith-python-sdk) allows you to [stream outputs](/oss/python/langgraph/streaming/) from the LangGraph API server.
...
LangSmith allows you to join an active [background run](/langsmith/background-run) and stream outputs from it. To do so, you can use [LangGraph SDK's](/langsmith/smith-python-sdk) `client.runs.join_stream` method:
