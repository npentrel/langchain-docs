...
To create an assistant, use the [LangGraph SDK](/langsmith/sdk) `create` method. See the [Python](/langsmith/smith-python-sdk#langgraph_sdk.client.AssistantsClient.create) and [JS](/langsmith/smith-js-ts-sdk#create) SDK reference docs for more information.
...
To edit the assistant, use the `update` method. This will create a new version of the assistant with the provided edits. See the [Python](/langsmith/smith-python-sdk#langgraph_sdk.client.AssistantsClient.update) and [JS](/langsmith/smith-js-ts-sdk#update) SDK reference docs for more information.
