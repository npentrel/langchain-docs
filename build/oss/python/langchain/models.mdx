...
Some model providers offer built-in tools that can be enabled via model or invocation parameters. Check the respective [provider reference](/oss/python/integrations/providers) for details.
