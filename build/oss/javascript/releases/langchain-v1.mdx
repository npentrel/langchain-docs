...
For a complete list of changes, see the [migration guide](/oss/javascript/langchain/middleware#built-in-middleware/migrate/langchain-v1).
...
![Middleware flow diagram](/oss/images/middleware_final.png)
