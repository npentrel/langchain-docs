...
<Steps>
    ...
    <Step title="Add documentation">
        ...
        <Accordion title="Integration documentation guide" icon="book">
            ...
            - [Chat models](https://github.com/langchain-ai/docs/blob/main/src/oss/python/oss/integrations/chat/TEMPLATE.mdx)
            - [Tools and toolkits](https://github.com/langchain-ai/docs/blob/main/src/oss/python/oss/integrations/tools/TEMPLATE.mdx)
            - [Retrievers](https://github.com/langchain-ai/docs/blob/main/src/oss/python/oss/integrations/retrievers/TEMPLATE.mdx)
            - Text splitters - Coming soon
            - Embedding models - Coming soon
            - [Vector stores](https://github.com/langchain-ai/docs/blob/main/src/oss/python/oss/integrations/vectorstores/TEMPLATE.mdx)
